...
import com.example.tonikarimovicapp.webrtc.audio.AudioHandler
import com.example.tonikarimovicapp.webrtc.audio.AudioSwitchHandler
import com.example.tonikarimovicapp.webrtc.client.SignalingClient
import com.example.tonikarimovicapp.webrtc.client.SignalingCommand
import com.example.tonikarimovicapp.webrtc.peer.StreamPeerConnectionFactory
import com.example.tonikarimovicapp.webrtc.peer.StreamPeerType
import com.example.tonikarimovicapp.webrtc.util.stringify
...
class WebRtcSessionManagerImpl(
  ...
  override fun enableMicrophone(enabled: Boolean) {
    logger.d { "TOGGLING MICROPHONE: $enabled" }
